"""Webcam continuous multi-sign recognition (fast+ pose/motion similarity).

Usage:
    python src/app_fast_plus.py

Leaves app_fast_continuous.py / fast_match.py unchanged.
...
from fast_match_plus import load_word_templates, recognize_stream
